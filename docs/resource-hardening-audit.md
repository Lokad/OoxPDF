...
| R15 chart data resolution | partial | presence checks + subset normalization; existence short-circuits; bar label hoist; per-frame shared dense label memo + mechanics test; suite 1677/0/9 |
