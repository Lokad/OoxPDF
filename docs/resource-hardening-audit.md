...
| R15 chart data resolution | partial | presence checks + subset normalization; existence short-circuits; per-frame shared dense label and series-name memos + mechanics tests; suite 1678/0/9 |
