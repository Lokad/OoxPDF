...
| R15 chart data resolution | partial | presence checks + subset normalization; existence short-circuits; per-frame shared dense label, series-name, and series-vector memos; sparse tick-edge max counts and shared bar extents + mechanics tests; suite 1682/0/9 |
