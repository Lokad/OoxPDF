...
internal static class PptxChartsTests
{
    ...
    public static void PptxSyntheticSingleSeriesVaryColorsOverflowSlots7Plus()
    {
        ...
        // Office dash7 through dash27 fills agree: slot7 light steel
        ...
        // slots 1-6 keep the 0.88 shade, slot-27-plus keeps shaded cycling (slot27 mint single sample).
        ...
        TestAssert.Equal(false, (bool)method.Invoke(null, twentySeventh)!);
    }
