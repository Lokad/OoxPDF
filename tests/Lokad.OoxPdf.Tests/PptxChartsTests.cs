...
var tail = rendererType.GetMethod(
    ...
    public static void PptxSyntheticSeventeenthVaryColorsRegime()
    {
        ...
        // Seventeenth-regime sixteenth-tail replay (slots 101-104), dash102/dash103 agree bit-identical.
        int[] sixteenthTailReplayIdx = [100, 101, 102, 103];
        int[] sixteenthTailReplayR = [199, 251, 211, 234];
        int[] sixteenthTailReplayG = [222, 215, 218, 211];
        int[] sixteenthTailReplayB = [231, 199, 233, 211];
        ...
        object?[] sixteenthTailReplayPast = [104, null];
