...
internal static class PptxTests
{
    ...
    public static void PptxSyntheticTextBoxUsesListStyleDefaults()
    {
        ...
        TestAssert.Contains("1 0 0 rg", pdf);
        TestAssert.Contains("1 0 0 1 79.2 421.2 Tm", pdf);
        TestAssert.Contains("1 0 0 1 79.2 378 Tm", pdf);
    }
    ...
    public static void PptxSyntheticTextBoxHonorsParagraphSpacing()
    {
        ...
        string pdf = File.ReadAllText(output, Encoding.ASCII);
        TestAssert.Contains("1 0 0 1 79.2 442.8 Tm", pdf);
    }
    ...
    public static void PptxSyntheticTextBoxHonorsNormAutofitLineSpacingReduction()
    {
        ...
        TestAssert.True(lines.All(line => Math.Abs(line.Advance - 32.4d) < 0.01d), "Expected normAutofit line spacing reduction to scale explicit percentage line spacing over normal PPTX line height.");
            ...
            ["ppt/charts/chart2.xml"] = TestFixtures.Utf8("""
                ...
                <c:chartSpace xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart"
                  ...
                  <c:chart><c:plotArea><c:barChart>
                    <c:varyColors val="1"/>
                    <c:ser>
                    <c:dPt><c:idx val="2"/><c:spPr><a:solidFill><a:srgbClr val="AA00AA"/></a:solidFill></c:spPr></c:dPt>
                    <c:val><c:numLit>
                      <c:pt idx="0"><c:v>2</c:v></c:pt>
                      <c:pt idx="1"><c:v>4</c:v></c:pt>
    ...
    public static void PptxSyntheticLineAndPieChartsUseStaticFallbacks()
    {
        string input = TestFixtures.WriteTempPackage(".pptx", new Dictionary<string, byte[]>
        {
            ...
            ["ppt/charts/chart1.xml"] = TestFixtures.Utf8("""
                ...
                <c:chartSpace xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart"
                  ...
                  <c:valAx><c:scaling><c:min val="0"/><c:max val="10"/></c:scaling><c:majorUnit val="2"/><c:minorUnit val="1"/><c:majorGridlines/><c:minorGridlines/><c:spPr><a:ln><a:solidFill><a:srgbClr val="00AA00"/></a:solidFill></a:ln></c:spPr></c:valAx><c:lineChart>
    ...
    public static void PptxSyntheticAreaScatterRadarAndDoughnutChartsUseStaticFallbacks()
    {
        string input = TestFixtures.WriteTempPackage(".pptx", new Dictionary<string, byte[]>
        {
            ["[Content_Types].xml"] = TestFixtures.Utf8(BasicContentTypes()),
        ...
        TestAssert.Contains(" c", pdf);
        TestAssert.Contains(" l S", pdf);
        TestAssert.True(collector.Diagnostics.Count(d => d.Id == "PPTX_CHART_STATIC_FALLBACK") == 4, "Expected static fallbacks for area, scatter, radar, and doughnut charts.");
        TestAssert.True(collector.Diagnostics.All(d => d.Id != "PPTX_UNSUPPORTED_CHART"), "Supported chart fallbacks should not emit unsupported chart diagnostics.");
    }
