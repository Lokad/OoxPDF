...
internal sealed class PptxSceneBuilder
{
    ...
    private static PptxSceneChartTitle ReadChartTitle(XDocument? chartXml, PptxTheme theme, IReadOnlyList<PptxSceneChartPlot> plots)
    {
        ...
        return ReadChartTitleElement(chart.Element(ChartNamespace + "title"), theme, isAutoDeleted, plots);
    }

    private static PptxSceneChartTitle ReadChartTitleElement(XElement? title, PptxTheme theme, bool? isAutoDeleted = null, IReadOnlyList<PptxSceneChartPlot>? plots = null)
    {
        if (title is null)
        {
            ...
            return string.IsNullOrWhiteSpace(inferredText)
                ...
                : new PptxSceneChartTitle(
                    ...
                    Overlay: null,
                    default,
                    new PptxSceneChartShapeStyle(false, default, default, default, default),
                    default);
        }
