...
internal sealed partial class PptxRenderer
{
    ...
    // Fixed overflow tints (dash7 through dash32 Office fills agree),
    ...
    // and post-palest slot-31 lavender-blue (dash31/dash32 agree); slot-32-plus keeps shaded cycling (coral single sample).
