...
internal sealed partial class PptxRenderer
{
    ...
    // Twenty-ninth-regime gate: one-hundred-seventy-four-plus points keep earlier rows, and replay nineteenth/seventeenth/twentythird/ninth/tenth/sixteenth/twelfth/overflow/fourth/fifth/thirteenth/seventh/eighth/eleventh/eighteenth/twentysixth rows past fifty-two.

    private static bool UseTwentyNinthVaryColorsRegime(int valuePointCount)
    {
        return valuePointCount >= PptxChartMetricRules.SingleSeriesVaryColorsTwentyNinthRegimePointThreshold;
    }
    ...
    {
        return valuePointCount >= PptxChartMetricRules.SingleSeriesVaryColorsTwentySeventhRegimePointThreshold;
    }
    ...
    private static bool TryResolveTwentySixthRegimeLateSingleFill(int categoryIndex, out RgbColor fill)
    {
        ...
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentySixthRegimeSlot159Fill;
            return true;
        }
    ...
    private static bool TryResolveTwentySixthRegimeTailFill(int categoryIndex, out RgbColor fill)
    {
    ...
    private static bool TryResolveTwentySeventhRegimeTailFill(int categoryIndex, out RgbColor fill)
    {
    ...
    private static bool TryResolveTwentyEighthRegimeLateSingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 168)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentyEighthRegimeSlot169Fill;
            return true;
        }

        if (categoryIndex == 169)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentyEighthRegimeSlot170Fill;
            return true;
        }

        if (categoryIndex == 170)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentyEighthRegimeSlot171Fill;
            return true;
        }
    ...
    private static bool TryResolveTwentyEighthRegimeTailFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 171)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentySecondRegimeSlot136Fill;
            return true;
        }
    ...
    private static bool TryResolveTwentyNinthRegimeLateSingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 174)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentyNinthRegimeSlot175Fill;
            return true;
        }
    ...
    private static bool TryResolveTwentyNinthRegimeNineteenthSingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 53)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsNineteenthRegimeSlot36Fill;
    ...
    private static bool TryResolveTwentyNinthRegimeSeventeenthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 77)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsSeventeenthRegimeSlot48Fill;
    ...
    private static bool TryResolveTwentyNinthRegimeTwentyThirdFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 90)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentyThirdRegimeSlot73Fill;
    ...
    private static bool TryResolveTwentyNinthRegimeNinthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 96)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsNinthRegimeSlot31Fill;
    ...
    private static bool TryResolveTwentyNinthRegimeTenthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 102)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTenthRegimeSlot37Fill;
    ...
    private static bool TryResolveTwentyNinthRegimeSixteenthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 108)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsSixteenthRegimeSlot61Fill;
    ...
    private static bool TryResolveTwentyNinthRegimeTwelfthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 114)
        {
    ...
    private static bool TryResolveTwentyNinthRegimeOverflowFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 120)
        {
    ...
    private static bool TryResolveTwentyNinthRegimeFourthFill(int categoryIndex, out RgbColor fill)
    {
    ...
    private static bool TryResolveTwentyNinthRegimeFifthFill(int categoryIndex, out RgbColor fill)
    {
    ...
    private static bool TryResolveTwentyNinthRegimeThirteenthFill(int categoryIndex, out RgbColor fill)
    {
    ...
    private static bool TryResolveTwentyNinthRegimeSeventhFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 138)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsSeventhRegimeSlot37Fill;
    ...
    private static bool TryResolveTwentyNinthRegimeEighthFill(int categoryIndex, out RgbColor fill)
    {
    ...
    private static bool TryResolveTwentyNinthRegimeEleventhFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 153)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsEleventhRegimeSlot64Fill;
    ...
    private static bool TryResolveTwentyNinthRegimeEighteenthSingleFill(int categoryIndex, out RgbColor fill)
    {
    ...
    private static bool TryResolveTwentyNinthRegimeTwentySixthSingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 172)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentySixthRegimeSlot155Fill;
            return true;
        }
    ...
    private static bool TryResolveTwentySeventhRegimeEarlySingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 5)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentySeventhRegimeSlot6Fill;
            return true;
        }
    ...
    private static bool TryResolveTwentySeventhRegimeLateSingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 162)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentySeventhRegimeSlot163Fill;
            return true;
        }

        if (categoryIndex == 163)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentySeventhRegimeSlot164Fill;
            return true;
        }

        if (categoryIndex == 164)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentySeventhRegimeSlot165Fill;
            return true;
        }
    ...
    private static bool TryResolveTwentySeventhRegimeSeventeenthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 31)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsSeventeenthRegimeSlot20Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeNineteenthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 41)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsNineteenthRegimeSlot30Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeSeventhFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 36)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsSeventhRegimeSlot7Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeEighteenthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 72)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsEighteenthRegimeSlot49Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeEleventhFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 102)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsEleventhRegimeSlot43Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeTwentyThirdFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 84)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentyThirdRegimeSlot73Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeFifteenthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 96)
        {
    ...
    private static bool TryResolveTwentySeventhRegimeTwelfthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 108)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwelfthRegimeSlot49Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeSixthSingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 131)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsSixthRegimeSlot36Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeNinthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 120)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsNinthRegimeSlot43Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeOverflowFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 127)
        {
    ...
    private static bool TryResolveTwentySeventhRegimeEighthFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 136)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsEighthRegimeSlot47Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeSixteenthSingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 155)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsSixteenthRegimeSlot96Fill;
    ...
    private static bool TryResolveTwentySeventhRegimeTwentySixthSingleFill(int categoryIndex, out RgbColor fill)
    {
        if (categoryIndex == 160)
        {
            fill = PptxChartMetricRules.SingleSeriesVaryColorsTwentySixthRegimeSlot155Fill;
    ...
    private static RgbColor ResolveShadedSingleSeriesVaryColorsFill(RgbColor paletteColor, int categoryIndex, int valuePointCount)
    {
        ...
        if (UseTwentyNinthVaryColorsRegime(valuePointCount))
        {
            ...
            {
                return twentyNinthNineteenthSingleFill;
            }

            if (TryResolveTwentyNinthRegimeSeventeenthFill(categoryIndex, out RgbColor twentyNinthSeventeenthFill))
            {
                return twentyNinthSeventeenthFill;
            }

            if (TryResolveTwentyNinthRegimeTwentyThirdFill(categoryIndex, out RgbColor twentyNinthTwentyThirdFill))
            {
                return twentyNinthTwentyThirdFill;
            }

            if (TryResolveTwentyNinthRegimeNinthFill(categoryIndex, out RgbColor twentyNinthNinthFill))
            {
                return twentyNinthNinthFill;
            }

            if (TryResolveTwentyNinthRegimeTenthFill(categoryIndex, out RgbColor twentyNinthTenthFill))
            {
                return twentyNinthTenthFill;
            }

            if (TryResolveTwentyNinthRegimeSixteenthFill(categoryIndex, out RgbColor twentyNinthSixteenthFill))
            {
                return twentyNinthSixteenthFill;
            }

            if (TryResolveTwentyNinthRegimeTwelfthFill(categoryIndex, out RgbColor twentyNinthTwelfthFill))
            {
                return twentyNinthTwelfthFill;
            }

            if (TryResolveTwentyNinthRegimeOverflowFill(categoryIndex, out RgbColor twentyNinthOverflowFill))
            {
                return twentyNinthOverflowFill;
            }

            if (TryResolveTwentyNinthRegimeFourthFill(categoryIndex, out RgbColor twentyNinthFourthFill))
            {
                return twentyNinthFourthFill;
            }

            if (TryResolveTwentyNinthRegimeFifthFill(categoryIndex, out RgbColor twentyNinthFifthFill))
            {
                return twentyNinthFifthFill;
            }

            if (TryResolveTwentyNinthRegimeThirteenthFill(categoryIndex, out RgbColor twentyNinthThirteenthFill))
            {
                return twentyNinthThirteenthFill;
            }

            if (TryResolveTwentyNinthRegimeSeventhFill(categoryIndex, out RgbColor twentyNinthSeventhFill))
            {
                return twentyNinthSeventhFill;
            }

            if (TryResolveTwentyNinthRegimeEighthFill(categoryIndex, out RgbColor twentyNinthEighthFill))
            {
                return twentyNinthEighthFill;
            }

            if (TryResolveTwentyNinthRegimeEleventhFill(categoryIndex, out RgbColor twentyNinthEleventhFill))
            {
                return twentyNinthEleventhFill;
            }

            if (TryResolveTwentyNinthRegimeEighteenthSingleFill(categoryIndex, out RgbColor twentyNinthEighteenthSingleFill))
            {
                return twentyNinthEighteenthSingleFill;
            }

            if (TryResolveTwentyNinthRegimeTwentySixthSingleFill(categoryIndex, out RgbColor twentyNinthTwentySixthSingleFill))
            {
                return twentyNinthTwentySixthSingleFill;
            }

            if (TryResolveTwentyNinthRegimeLateSingleFill(categoryIndex, out RgbColor twentyNinthLateSingleFill))
            {
                return twentyNinthLateSingleFill;
            }
        ...
        if (UseTwentyEighthVaryColorsRegime(valuePointCount))
        {
            ...
            if (TryResolveTwentyEighthRegimeLateSingleFill(categoryIndex, out RgbColor twentyEighthLateSingleFill))
            {
                return twentyEighthLateSingleFill;
            }

            if (TryResolveTwentyEighthRegimeTailFill(categoryIndex, out RgbColor twentyEighthTailFill))
            {
                return twentyEighthTailFill;
            }
        ...
        if (UseTwentySeventhVaryColorsRegime(valuePointCount))
        {
            ...
            {
                return twentySeventhSeventeenthFill;
            }

            if (TryResolveTwentySeventhRegimeNineteenthFill(categoryIndex, out RgbColor twentySeventhNineteenthFill))
            {
                return twentySeventhNineteenthFill;
            }

            if (TryResolveTwentySeventhRegimeSeventhFill(categoryIndex, out RgbColor twentySeventhSeventhFill))
            {
                return twentySeventhSeventhFill;
            }

            if (TryResolveTwentySeventhRegimeEighteenthFill(categoryIndex, out RgbColor twentySeventhEighteenthFill))
            {
                return twentySeventhEighteenthFill;
            }

            if (TryResolveTwentySeventhRegimeEleventhFill(categoryIndex, out RgbColor twentySeventhEleventhFill))
            {
                return twentySeventhEleventhFill;
            }

            if (TryResolveTwentySeventhRegimeTwentyThirdFill(categoryIndex, out RgbColor twentySeventhTwentyThirdFill))
            {
                return twentySeventhTwentyThirdFill;
            }

            if (TryResolveTwentySeventhRegimeFifteenthFill(categoryIndex, out RgbColor twentySeventhFifteenthFill))
            {
                return twentySeventhFifteenthFill;
            }

            if (TryResolveTwentySeventhRegimeTwelfthFill(categoryIndex, out RgbColor twentySeventhTwelfthFill))
            {
                return twentySeventhTwelfthFill;
            }

            if (TryResolveTwentySeventhRegimeSixthSingleFill(categoryIndex, out RgbColor twentySeventhSixthSingleFill))
            {
                return twentySeventhSixthSingleFill;
            }

            if (TryResolveTwentySeventhRegimeNinthFill(categoryIndex, out RgbColor twentySeventhNinthFill))
            {
                return twentySeventhNinthFill;
            }

            if (TryResolveTwentySeventhRegimeOverflowFill(categoryIndex, out RgbColor twentySeventhOverflowFill))
            {
                return twentySeventhOverflowFill;
            }

            if (TryResolveTwentySeventhRegimeEighthFill(categoryIndex, out RgbColor twentySeventhEighthFill))
            {
                return twentySeventhEighthFill;
            }

            if (TryResolveTwentySeventhRegimeSixteenthSingleFill(categoryIndex, out RgbColor twentySeventhSixteenthSingleFill))
            {
                return twentySeventhSixteenthSingleFill;
            }

            if (TryResolveTwentySeventhRegimeTwentySixthSingleFill(categoryIndex, out RgbColor twentySeventhTwentySixthSingleFill))
            {
                return twentySeventhTwentySixthSingleFill;
            }

            if (TryResolveTwentySeventhRegimeEarlySingleFill(categoryIndex, out RgbColor twentySeventhEarlySingleFill))
            {
                return twentySeventhEarlySingleFill;
            }

            if (TryResolveTwentySeventhRegimeLateSingleFill(categoryIndex, out RgbColor twentySeventhLateSingleFill))
            {
                return twentySeventhLateSingleFill;
            }

            if (TryResolveTwentySeventhRegimeTailFill(categoryIndex, out RgbColor twentySeventhTailFill))
            {
                return twentySeventhTailFill;
            }
        ...
        if (UseTwentySixthVaryColorsRegime(valuePointCount))
        {
            ...
            if (TryResolveTwentySixthRegimeTailFill(categoryIndex, out RgbColor twentySixthTailFill))
            {
                return twentySixthTailFill;
            }
