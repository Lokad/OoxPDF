    ...
    IReadOnlyList<DocxStructureTableAdjacencySnapshot> TableAdjacency)
{
        ...
        IReadOnlyList<DocxRelatedStory> relatedStories)
    {
        return new DocxStructureBlockSnapshot(
            ...
            ParagraphStyleFound: paragraph.StyleResolution.StyleFound,
            ParagraphStyleDepth: paragraph.StyleResolution.StyleDepth,
            HasDocumentDefaultParagraphProperties: paragraph.StyleResolution.HasDocumentDefaultParagraphProperties,
            HasDirectParagraphProperties: paragraph.StyleResolution.HasDirectParagraphProperties,
            HasTableStyleParagraphProperties: paragraph.StyleResolution.HasTableStyleParagraphProperties,
            ...
            BeforeAutoSpacingValue: paragraph.Spacing.BeforeAutoSpacingValue,
            AfterAutoSpacingValue: paragraph.Spacing.AfterAutoSpacingValue,
