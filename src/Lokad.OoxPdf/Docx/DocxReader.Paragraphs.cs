...
internal sealed partial class DocxReader
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new DocxParagraph(
            ...
            CreateListLabel(paragraphProperties, numbering, numberingCounters, styles, paragraphStyleId, tableCellStyle?.Run, runs.FirstOrDefault()?.FontSize ?? paragraphFontSize))
        {
