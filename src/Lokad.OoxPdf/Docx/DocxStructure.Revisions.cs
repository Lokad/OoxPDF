...
internal sealed partial record DocxStructureSnapshot
{
        ...
        string? nextKind)
    {
        ...
        return new DocxStructureTableAdjacencySnapshot(
            ...
            previousParagraph is null ? null : DocxParagraphSpacing.HasAfterSpacingSide(previousParagraph.EffectiveProperties.Spacing),
            nextParagraph?.EffectiveProperties.StyleId,
            nextParagraph?.EffectiveProperties.SpacingBeforePoints,
            nextParagraph is null ? null : DocxParagraphSpacing.HasBeforeSpacingSide(nextParagraph.EffectiveProperties.Spacing),
