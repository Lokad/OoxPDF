...
- [ ] Ladder 1: plain paragraphs with Word reference baselines, line height, paragraph before/after spacing, and page margins. First subcase `docx-ladder-01-plain-paragraph` is gated; remaining subcases should isolate multi-line flow and before/after spacing.
